"""
 Adapted from: https://raw.githubusercontent.com/lisa-lab/DeepLearningTutorials/master/code/cA.py
...
def test_cA(learning_rate=0.01, training_epochs=20,
    ...
    ca = cA(numpy_rng=rng, input=x,
            ...
            n_hidden=500, n_batchsize=batch_size)
    ...
    #print c
    print "len(c)", len(c)
    print "len(train_set_x)", train_set_x.shape
